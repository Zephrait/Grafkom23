...
//        Bind VBOColor
    ...
    public void rotateObject(Float angle, Float offsetX, Float offsetY, Float offsetZ) {
        model = new Matrix4f().rotate(angle,offsetX,offsetY,offsetZ).mul(new Matrix4f(model));
    }
